...
class PlayState extends MusicBeatState
{
	...
	public static final exampleSongs = ["yoursong1", "yoursong2", "yoursong3", "yoursong4"]; // List isn't really used since stage is default, but whatever.
	...
	override public function create()
	{
		...
		if (Assets.exists(Paths.text(SONG.song.toLowerCase() + "/" + SONG.song.toLowerCase() + "Dialogue")))
		{
			...
			{
				trace("Failed to load Dialogue for: " + SONG.song.toLowerCase() + " / " + "Reason/Error: " + e.message);
			}
		}
	...
	private function generateSong():Void
	{
		...
		for (section in noteData)
		{
			...
			for (songNotes in section.sectionNotes)
			{
				...
				{
					// leave this here otherwise the game crashes
				}
			}
			daBeats++;
		}
